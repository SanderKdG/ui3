export default function getNationalities() {
  return [{ NationalityID: 0, CountryCode: 'ZZ', Nationality: '' },
  ...
  { NationalityID: 101, CountryCode: 'LU', Nationality: 'Luxembourgish' },
  ...
  { NationalityID: 164, CountryCode: 'BE', Nationality: 'Belgian' }
  ];
}